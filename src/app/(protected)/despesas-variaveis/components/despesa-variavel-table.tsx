...
import { getCategoriesAction, updateDespesaVariavelAction } from "../actions";
...
interface DespesaVariavelTableProps {
...
export function DespesaVariavelTable({ despesas }: DespesaVariavelTableProps) {
  ...
  const { execute, isPending } = useAction(updateDespesaVariavelAction, {
    onSuccess: () => {
    ...
    onError: (error) => {
      toast.error(
        error.error.serverError || "Erro ao atualizar despesa variável"
      );
    },
  });
  ...
  const handleRowClick = (despesa: DespesaVariavel) => {
    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>Editar Despesa Variável</DialogTitle>
            <DialogDescription>
              Atualize as informações da sua despesa variável.
            </DialogDescription>
          </DialogHeader>
          <Form {...form}>
