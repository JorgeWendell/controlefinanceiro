...
import { createDividaAction } from "../actions";
...
export function DividaFormDialog() {
  ...
  const { execute, isPending } = useAction(createDividaAction, {
    onSuccess: () => {
    ...
    onError: (error) => {
      toast.error(error.error.serverError || "Erro ao cadastrar dívida");
    },
  });
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Adicione uma nova dívida ao seu controle financeiro.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
