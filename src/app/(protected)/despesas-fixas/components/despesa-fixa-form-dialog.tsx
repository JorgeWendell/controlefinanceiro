...
import { createDespesaFixaAction, getCategoriesAction } from "../actions";
...
export function DespesaFixaFormDialog() {
  ...
  const { execute, isPending } = useAction(createDespesaFixaAction, {
    onSuccess: () => {
    ...
    onError: (error) => {
      toast.error(error.error.serverError || "Erro ao cadastrar despesa fixa");
    },
  });
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[90vh] w-[95vw] max-w-[500px] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Adicione uma nova despesa fixa ao seu controle financeiro.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
